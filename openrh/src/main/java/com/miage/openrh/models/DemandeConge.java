...
import java.util.ArrayList;
    ...
    public class DemandePermission {
        ...
        public DemandePermission(String mat_emp, String nom, String prenom, String date_depart, String date_retour,String piece_jointe,String type_conge,String motif) {
            this.mat_emp = mat_emp;
            this.nom = nom;
            this.prenom = prenom;
            this.date_depart = date_depart;
        ...
        public void save() throws SQLException {
            ...
            db.sendQuery("INSERT INTO demandeConge(mat_emp,nom,prenom,date_depart,date_retour,piece_jointe,type_conge,motif) VALUES(?,?,?,?,?,?,?,?)", new ArrayList<>() {
                {
                    add(mat_emp);
                    add(nom);
                    add(prenom);
